...
// Convertire l'array in formato JSON
$json = json_encode($arrayOggetti);

// Salvare il JSON su un file
$file = fopen('Sensori/Fogli.dat', 'w');
fwrite($file, $json);
fclose($file);
...
// $oggetti = array(
    // new Oggetto("Oggetto 1", 100),
    // new Oggetto("Oggetto 2", 200),
    // new Oggetto("Oggetto 3", 300)
// );

// // Serializzare la lista di oggetti
// $serializzato = serialize($oggetti);

// // Stampare la lista serializzata
// echo '<br/>';
// echo $serializzato;
